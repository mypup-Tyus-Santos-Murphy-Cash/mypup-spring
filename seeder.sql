...
', '$1,500.00');
insert into dog_posts (dog_breed, dog_group, dog_description, dog_price) values ('Afghan Hound', 'Hound', 'The Afghan Hound is an aloof and dignified aristocrat of sublime beauty. Despite his regal appearance, he is known for his profound loyalty, sensitive nature, and absolute love for those he calls his own.
', '$1,200.00');
insert into dog_posts (dog_breed, dog_group, dog_description, dog_price) values ('Beagle', 'Hound', 'Not only is the Beagle an excellent hunting dog and loyal companion, it is also happy-go-lucky, funny, and—thanks to its pleading expression—cute. They were bred to hunt in packs, so they enjoy company and are generally easygoing.
', '$900.00');
insert into dog_posts (dog_breed, dog_group, dog_description, dog_price) values ('Silky Terrier', 'Toy', 'A charming member of the AKC Toy Group, the compact, glossy-coated Silky Terrier is nonetheless a true terrier of energetic high spirits. The Silky, a native of Sydney, Australia, is larger than his close cousin, the Yorkshire Terrier.
', '$1,200.00');
insert into dog_posts (dog_breed, dog_group, dog_description, dog_price) values ('Pug', 'Toy', 'Once the mischievous companion of Chinese emperors, and later the mascot of Hollands royal House of Orange, the small but solid Pug is today adored by his millions of fans around the world. Pugs live to love and to be loved in return.
', '$1,500.00');
insert into dog_posts (dog_breed, dog_group, dog_description, dog_price) values ('French Bulldog', 'Non-Sporting', 'The one-of-a-kind French Bulldog, with his large bat ears and even disposition, is one of the world''s most popular small-dog breeds, especially among city dwellers. The Frenchie is playful, alert, adaptable, and completely irresistible.
', '$3,000.00');
insert into dog_posts (dog_breed, dog_group, dog_description, dog_price) values ('Dalmatian', 'Non-Sporting', 'The dignified Dalmatian, dogdom''s citizen of the world, is famed for his spotted coat and unique job description. During their long history, these "coach dogs" have accompanied the horse-drawn rigs of nobles, gypsies, and firefighters.
', '$1,500.00');
insert into dog_posts (dog_breed, dog_group, dog_description, dog_price) values ('American Staffordshire Terrier', 'Terrier', 'The American Staffordshire Terrier, known to their fans as AmStaffs, are smart, confident, good-natured companions. Their courage is proverbial. A responsibly bred, well-socialized AmStaff is a loyal, trustworthy friend to the end.
', '$1,200.00');
insert into dog_posts (dog_breed, dog_group, dog_description, dog_price) values ('Bull Terrier', 'Terrier', 'Among the most comical and mischievous citizens of dogdom, the Bull Terrier is playful and endearing, sometimes stubborn, but always devoted. These unique "eggheads" are exuberant, muscular companions who thrive on affection and exercise.
', '$2,000.00');
insert into dog_posts (dog_breed, dog_group, dog_description, dog_price) values ('Akita', 'Working ', 'Akitas are muscular, double-coated dogs of ancient Japanese lineage famous for their dignity, courage, and loyalty. In their native land, they are venerated as family protectors and symbols of good health, happiness, and long life.
', '$1,000.00');
insert into dog_posts (dog_breed, dog_group, dog_description, dog_price) values ('Cane Corso', 'Working', 'Smart, trainable, and of noble bearing, the assertive and confident Cane Corso is a peerless protector. The Corso''s lineage goes back to ancient Roman times, and the breed''s name roughly translates from the Latin as "bodyguard dog."
', '$2,000.00');
insert into dog_posts (dog_breed, dog_group, dog_description, dog_price) values ('Barbet', 'Miscellaneous', 'An archetypic water dog of France, the Barbet is a rustic breed of medium size and balanced proportions who appears in artwork as early as the 16th century. In profile, the Barbet is slightly rectangular with a substantial head and long, sweeping tail. He has a long, dense covering of curly hair and a distinctive beard. An agile athlete, the Barbet has been used primarily to locate, flush, and retrieve birds. He has a cheerful disposition and is very social and loyal.
', '$1,800.00');
